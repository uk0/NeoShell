...
const entries = (t: Dict) => [
  ...
  { cat: "changed", items: ["cl.changed.1","cl.changed.2","cl.changed.3","cl.changed.4","cl.changed.5"] },
  { cat: "fixed", items: ["cl.fixed.1","cl.fixed.2","cl.fixed.3"] },
].map(b => ({ ...b, title: t(`cl.category.${b.cat}` as any), lines: b.items.map(k => t(k as any)) }));

/**
 * Changelog — single rollup entry for v0.7.0, rendered as a timeline
      ...
      <div className="wrap">
        <div className="changelog-head">
          ...
          <div className="changelog-meta">
            <span className="mono changelog-ver">v0.7.0</span>
